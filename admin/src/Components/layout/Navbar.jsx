...
export default function Navbar() {
  ...
  return (
    <header
      className={`sticky top-0 z-50 border-b bg-white transition-colors ${scrolled ? "border-neutral-100" : "border-transparent"}`}
    >
      <nav
      ...
      >
        <Link
          ...
          aria-label="Research Academy Bangladesh home"
        >
          <img
            src={logo}
            alt="Research Academy Bangladesh logo"
          ...
          <span className="hidden flex-col leading-tight sm:flex">
            ...
            <span className="-mt-1 text-sm font-bold text-secondary-dark">
              BANGLADESH
            </span>
          </span>
        </Link>
      ...
      {open && (
        <div
          id="mobile-menu"
          className="border-t border-neutral-100 bg-white px-4 pb-6 lg:hidden"
        >
