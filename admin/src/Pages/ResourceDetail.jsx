  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-4xl px-4 py-14 lg:px-8">
        <Link
          to="/resources"
          className="hover-underline-gold mb-4 inline-block text-sm text-primary"
        >
          ← Back to Resources
        </Link>
        <img
        ...
        <p className="mb-6 text-xs text-neutral-700">
          © {new Date().getFullYear()} Research Academy Bangladesh. This
          resource is provided for personal and institutional research use.
