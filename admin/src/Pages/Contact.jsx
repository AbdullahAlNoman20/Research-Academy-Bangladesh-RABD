...
const FAQS = [
  { question: 'How do I enroll in a course?', answer: 'Visit the Apply Now page, select your program of interest, and submit the application form. Our team will contact you within 2 business days.' },
  { question: 'Are certificates provided upon completion?', answer: 'Yes, all courses and most workshops include a certificate of completion issued by Research Academy Bangladesh.' },
  { question: 'Do you offer institutional training programs?', answer: 'Yes, our Research Training service is designed for hospitals, medical colleges, and universities. Contact us for a customized proposal.' },
  { question: 'Can I get one-on-one mentorship?', answer: 'Yes, our Research Mentorship service pairs you with an experienced academic mentor for long-term guidance.' }
];
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
            ...
            <div>
              ...
              <input id="email" name="email" type="email" required maxLength={254} value={form.email} onChange={handleChange}
                className="w-full rounded-md border border-neutral-100 px-3 py-2 text-sm focus:border-primary focus:outline-none" />
            ...
            <div>
              ...
              <input id="phone" name="phone" type="tel" maxLength={20} value={form.phone} onChange={handleChange}
                className="w-full rounded-md border border-neutral-100 px-3 py-2 text-sm focus:border-primary focus:outline-none" />
            ...
            <div>
              ...
              <textarea id="message" name="message" required rows={5} maxLength={2000} value={form.message} onChange={handleChange}
                className="w-full rounded-md border border-neutral-100 px-3 py-2 text-sm focus:border-primary focus:outline-none" />
          ...
          <div className="flex flex-col gap-6">
            <div>
              <h3 className="mb-2 text-sm font-bold text-primary">Head Office</h3>
